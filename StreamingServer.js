...
let port = '9999';  //port number that will bind to the hostname?
...
let server = http.createServer(function(req, res){
  ...
  fs.exists(filepath, function(file_exists){
    ...
    if(file_exists){
      ...
      //new Steaming method that is more efficient
      res.writeHead(200, {'Content-Type' : contentType});
      //instantiate a stream to bring the file in
      //then .pipe method is appended to serve the file/response out back to the user
